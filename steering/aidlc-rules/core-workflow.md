...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from rule detail files. Use the following path:
- `aidlc-rule-details/` (default rule details directory)
